...
open class DatePickerDialog: UIView {
    ...
    // MARK: - Constants
    private let kDefaultButtonHeight: CGFloat = 46
    ...
    @objc func deviceOrientationDidChange(_ notification: Notification) {
        ...
        let dialogSize = CGSize(width: UIScreen.main.bounds.size.width, height: 230 + kDefaultButtonHeight + kDefaultButtonSpacerHeight)
        dialogView.frame = CGRect(
            x: 0,
            y: (UIScreen.main.bounds.size.height - dialogSize.height),
    ...
    private func createContainerView() -> UIView {
        ...
        let dialogSize = CGSize(width: screenSize.width, height: 230 + kDefaultButtonHeight + kDefaultButtonSpacerHeight)
        ...
        container.backgroundColor = UIColor.init(hexString: "#FFFFFF")
        ...
        let yPosition = kDefaultButtonHeight
        ...
        //Title
        self.titleLabel = UILabel(frame: CGRect(x: 0, y: 10, width: screenSize.width/2.0, height: 30))
        self.titleLabel.textAlignment = .center
        self.titleLabel.center = CGPoint.init(x: screenSize.width/2.0, y: 25.0)
        self.titleLabel.textColor = UIColor.init(hexString: "#333333")
        self.titleLabel.font = self.font.withSize(16)
    ...
    fileprivate func configuredDatePicker() -> UIDatePicker {
        let datePicker = UIDatePicker(frame: CGRect(x: (UIScreen.main.bounds.size.width - 320.0)/2, y: kDefaultButtonHeight + kDefaultButtonSpacerHeight, width: 0, height: 0))
...
//        datePicker.backgroundColor = UIColor.white
    ...
    private func addButtonsToView(container: UIView) {
        let screenSize = UIScreen.main.bounds.size
        var buttonWidth = container.bounds.size.width / 5
...
//        )
        ...
        var rightButtonFrame = CGRect(
            x:  screenSize.width - buttonWidth,
            y: 0,
            width: buttonWidth,
            height: kDefaultButtonHeight
        )
        ...
        if showCancelButton {
            ...
            self.cancelButton.setTitleColor(UIColor.init(hexString: "#999990"), for: .normal)
            self.cancelButton.setTitleColor( UIColor.init(hexString: "#999990"), for: .highlighted)
